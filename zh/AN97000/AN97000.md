...
<th style="text-align: right;"><strong>AN97000</strong></th>
</tr>
<tr>
...
<span id="_Toc238829891" class="anchor"></span>说明
...
<span id="_Toc238829892" class="anchor"></span>目录

[说明 [1](#_Toc238829891)](#_Toc238829891)

[目录 [2](#_Toc238829892)](#_Toc238829892)

[表格索引 [2](#_Toc238829893)](#_Toc238829893)

[图片索引 [2](#_Toc238829894)](#_Toc238829894)
...
[第2章 DFU 实现 [3](#dfu-实现)](#dfu-实现)

[1.4 总体方案 [3](#_Toc238829905)](#_Toc238829905)

[1.5 USB描述符设计 [3](#usb描述符设计)](#usb描述符设计)

[1.6 软件实现 [3](#软件实现)](#软件实现)

[1.6.1 软件架构 [3](#软件架构)](#软件架构)

[1.7 软件流程 [4](#软件流程)](#软件流程)

[1.7.1 DFU状态机与延迟操作机制
[4](#dfu状态机与延迟操作机制)](#dfu状态机与延迟操作机制)

[1.7.2 主机发送固件流程 [5](#主机发送固件流程)](#主机发送固件流程)

[1.7.3 擦除和设置地址流程 [5](#擦除和设置地址流程)](#擦除和设置地址流程)

[1.7.4 固件写入和读取流程 [8](#固件写入和读取流程)](#固件写入和读取流程)

[第3章 主机工具与升级操作
[12](#主机工具与升级操作)](#主机工具与升级操作)

[1.8 驱动安装 [12](#_Toc238829915)](#_Toc238829915)

[1.9 主机工具 [13](#主机工具)](#主机工具)

[历史版本 [15](#_Toc238829917)](#_Toc238829917)

[声明 [16](#_Toc238829918)](#_Toc238829918)

<span id="_Toc238829893" class="anchor"></span>表格索引

[DFU状态定义 [1](#_Toc238825545)](#_Toc238825545)

[GET STATUS响应格式 [1](#_Toc238825546)](#_Toc238825546)

[命令帧格式 [2](#_Toc238825547)](#_Toc238825547)

[零长度DNLOAD帧格式 [2](#_Toc238825548)](#_Toc238825548)

[ABORT帧格式 [2](#_Toc238825549)](#_Toc238825549)

[设备描述符关键参数 [3](#_Toc238825550)](#_Toc238825550)

[DFU功能描述符字段 [3](#_Toc238825551)](#_Toc238825551)

[Bootloader工程文件组成 [4](#_Toc238825552)](#_Toc238825552)

[主循环操作类型 [4](#_Toc238825553)](#_Toc238825553)

[dfu-util常用命令 [13](#_Toc238825554)](#_Toc238825554)

<span id="_Toc238829894" class="anchor"></span>图片索引

[总体结构图 [3](#_Toc238825555)](#_Toc238825555)

[主机执行流程 [5](#_Toc238825556)](#_Toc238825556)

[擦除和设置地址抓包 [6](#_Toc238825557)](#_Toc238825557)

[擦除流程 [6](#_Toc238721257)](#_Toc238721257)

[固件写入抓包 [8](#_Toc238721258)](#_Toc238721258)

[固件写入流程 [8](#_Toc238721259)](#_Toc238721259)

[固件读取抓包 [10](#_Toc238825561)](#_Toc238825561)

[固件读取流程 [10](#_Toc238825562)](#_Toc238825562)

[未安装驱动设备状态 [12](#_Toc238825563)](#_Toc238825563)

[驱动安装完成后设备状态 [12](#_Toc238721262)](#_Toc238721262)

[列举DFU设备演示 [13](#_Toc238721264)](#_Toc238721264)

[下载固件演示 [13](#_Toc238721265)](#_Toc238721265)

[读取固件演示 [14](#_Toc238721266)](#_Toc238721266)
...
表 1‑1 <span id="_Toc238825545" class="anchor"></span>DFU状态定义
...
表 1‑2 <span id="_Toc238825546" class="anchor"></span>GET STATUS响应格式
...
表 1‑3<span id="_Toc238825547" class="anchor"></span>命令帧格式
...
表 1‑4<span id="_Toc238825548" class="anchor"></span>零长度DNLOAD帧格式
...
表 1‑5 <span id="_Toc238825549" class="anchor"></span>ABORT帧格式

# DFU 实现

1.  <span id="_Toc238829905" class="anchor"></span>
...
图 2‑1 <span id="_Toc238825555" class="anchor"></span>总体结构图

## <img src="./media/image2.png"
style="width:5.99375in;height:1.28125in" />USB描述符设计
...
表 2‑1<span id="_Toc238825550" class="anchor"></span>设备描述符关键参数
...
表 2‑2 <span id="_Toc238825551" class="anchor"></span>DFU功能描述符字段

接口字符串（iInterface=4）承载存储器布局字符串：以@Internal Flash
/0x08005000/044\*001Kg为例，声明从0x08005000起连续44个1KB扇区、属性“g”表示可读可写可擦。dfu-util解析该字符串后即可自动完成分区擦除与下载。
...
表 2‑4<span id="_Toc238825553" class="anchor"></span>主循环操作类型

### 主机发送固件流程

![](./media/image3.emf)升级流程启动后，主机轮询设备状态，待设备空闲后依次下发擦除命令、设置地址指针命令，每发送一条指令都循环轮询等待设备回到空闲状态，之后循环发送固件数据包并持续查询设备状态，直至全部固件传输完成，最后主机发送零长度DNLOAD包，结束整个升级流程。主机执行流程图如图2-2所示。

图 2‑2<span id="_Toc238825556" class="anchor"></span>主机执行流程
...
<figcaption><p>图 2‑3<span id="_Toc238825557"
...
<figcaption><p>图 2‑4<span id="_Toc238721257"
...
![](./media/image6.emf)<img src="./media/image7.png"
style="width:5.30139in;height:2.00903in" />

图 2‑5<span id="_Toc238721258" class="anchor"></span>固件写入抓包
...
图 2‑6<span id="_Toc238721259" class="anchor"></span>固件写入流程
...
<figcaption><p>图 2‑7<span id="_Toc238825561"
...
图 2‑8<span id="_Toc238825562" class="anchor"></span>固件读取流程
...
2.  <span id="_Toc238829915" class="anchor"></span>
...
<figcaption><p>图 3‑1<span id="_Toc238825563"
...
<figcaption><p>图 3‑2<span id="_Toc238721262"
class="anchor"></span>驱动安装完成后设备状态</p></figcaption>
</figure>

## 主机工具

可直接使用开源命令行工具dfu-util进行固件写入和读取。dfu-util
常用命令如表3-1所示。
...
表 3‑1 <span id="_Toc238825554" class="anchor"></span>dfu-util常用命令

<figure>
<img src="./media/image12.png"
style="width:5.33913in;height:3.00373in" />
<figcaption><p>图 3‑3<span id="_Toc238721264"
...
style="width:5.32153in;height:2.99444in" />
<figcaption><p>图 3‑4<span id="_Toc238721265"
...
<figcaption><p>图 3‑5<span id="_Toc238721266"
...
<span id="_Toc238829917" class="anchor"></span>历史版本

| 日期      | 版本 | 变更内容 |
|-----------|------|----------|
| 2026/8/27 | V1.0 | 初版发行 |

<span id="_Toc238829918" class="anchor"></span>声明
