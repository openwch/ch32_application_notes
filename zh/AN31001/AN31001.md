...
<th>APPLICATION NOTE TEMPLATE</th>
</tr>
<tr>
<th>V1.0</th>
</tr>
...
<span id="_Toc239521645" class="anchor"></span>说明
...
<span id="_Toc239521646" class="anchor"></span>目录

[说明 [1](#_Toc239521645)](#_Toc239521645)

[目录 [2](#_Toc239521646)](#_Toc239521646)

[表格索引 [2](#_Toc239521647)](#_Toc239521647)

[图片索引 [2](#_Toc239521648)](#_Toc239521648)

[第1章 功能描述 [1](#功能描述)](#功能描述)

[1.1 DFSDM框图 [1](#dfsdm框图)](#dfsdm框图)

[1.2 DFSDM组件 [1](#dfsdm组件)](#dfsdm组件)

[1.3 ΣΔ调制器 [2](#σδ调制器)](#σδ调制器)

[第2章 MAC音频采集案例 [4](#mac音频采集案例)](#mac音频采集案例)

[2.1 概述 [4](#概述)](#概述)

[2.2 通道输入选择 [4](#通道输入选择)](#通道输入选择)

[2.3 立体声采集原理图 [4](#立体声采集原理图)](#立体声采集原理图)

[2.4 时钟与音频采样率 [5](#时钟与音频采样率)](#时钟与音频采样率)

[2.5 外设配置 [6](#外设配置)](#外设配置)

[历史版本 [10](#_Toc239521659)](#_Toc239521659)

[声明 [11](#_Toc239521660)](#_Toc239521660)

<span id="_Toc239521647" class="anchor"></span>表格索引

[音频数据输出速率 [6](#_Toc239521661)](#_Toc239521661)

<span id="_Toc239521648" class="anchor"></span>图片索引

[DFSDM外设框图 [1](#_Toc239521812)](#_Toc239521812)

[DFSDM与 ΣΔ调制器连接图 [2](#_Toc239521813)](#_Toc239521813)

[麦克风与DFSDM连接图 [4](#_Toc239521814)](#_Toc239521814)

[立体声采集原理图 [5](#_Toc239521815)](#_Toc239521815)
...
<figure>
<img src="./media/image2.png" style="width:6.37778in;height:2.7in" />
<figcaption><p>图 ‑1 <span id="_Toc239521812"
...
▇ 滤波器阶数/类型： FastSinc、Sinc<sup>1</sup>...Sinc<sup>5</sup>

▇ 滤波器过采样/抽取率：

\- FOSR=1-1024——适用于FastSinc滤波器和Sincx滤波器x=F<sub>ORD</sub>=1..3

\- FOSR=1-215——适用于Sinc<sup>x</sup>滤波器x=F<sub>ORD</sub>=4

\- FOSR=1-73——适用于Sinc<sup>x</sup>滤波器x=F<sub>ORD</sub>=5
...
style="width:4.91525in;height:1.35334in" />
<figcaption><p>图 ‑2 <span id="_Toc239521813"
...
style="width:5.64645in;height:2.52006in" />
<figcaption><p>图 ‑1<span id="_Toc239521814"
...
<figcaption><p>图 ‑2<span id="_Toc239521815"
...
<caption><p>表 2‑1<span id="_Toc239521661"
...
注：表中FOSR表示Sinc
滤波器过采样率，积分器过采样率为2IOSR，fCKOUT表示DFSDM输出的时钟CKOUT。

## 外设配置

以快速模式为例，假设要配置的音频采样率F<sub>S</sub> =
16KHz，DFSDM模块的滤波器选择3阶Sinc滤波器，过采样率为128，积分采样率为1（积分器旁路），则f<sub>CKOUT</sub>
= F<sub>S</sub> \* F<sub>OSR</sub> =
2.048MHz。如果DFSDM输出串行时钟源来自音频时钟，系统时钟SYSCLK =
295MHz，输出串行时钟分频系数应设置为144。SAI主时钟分频器MCLKDIV =
(SYSCLK / 6) / (F<sub>S</sub> \* 256)= 12。
...
<span id="_Toc239521659" class="anchor"></span>历史版本

| 日期     | 版本 | 变更内容 |
|----------|------|----------|
| 2026/6/1 | V1.0 | 初版发行 |

<span id="_Toc239521660" class="anchor"></span>声明
